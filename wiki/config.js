...
const CONFIG = {
    ...
    projectName: "OBSIDIAN-PYTHON-DS-STUDIO",
    projectSubtitle: "OBSIDIAN-PYTHON-DS-STUDIO WIKI",
    description: "Official Documentation and Wiki for obsidian-python-ds-studio",

    // Versioning Settings
    versioning: {
        type: "local",
        manualVersion: "1.2.0",
        manualDate: "2026-01-26"
    },

    // GitHub Repository
    repo: "infinition/obsidian-python-ds-studio",
    branch: "main",
    ...
    // Footer
    footerText: "© 2026 OBSIDIAN-PYTHON-DS-STUDIO WIKI - All rights reserved",
    ...
    social: {
        discord: null,
        reddit: null,
        github: "https://github.com/infinition/obsidian-python-ds-studio", // Virgule respectée par le script
    ...
    badges: {
        ...
        redditLabel: "REDDIT",
        githubLabel: "OBSIDIAN-PYTHON-DS-STUDIO"
    }
};